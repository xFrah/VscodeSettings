        ...
        if success:
            ...
            if session_started:
                if (current_timestamp - last_feature_timestamp) > 10:
                    current_background = cv2.cvtColor(current_background, cv2.COLOR_BGR2GRAY)
                    cropped = cv2.cvtColor(cropped, cv2.COLOR_BGR2GRAY)

                    cropped = exposure.equalize_adapthist(cropped)
                    current_background = exposure.equalize_adapthist(current_background)
