...
class _ConnectedDeviceScreenState extends State<ConnectedDeviceScreen> {
  ...
  @override
  Widget build(BuildContext context, {double circleSpacing = 0.0}) {
    final Size size = MediaQuery.of(context).size;
    final double circleRadius = size.width * 0.5; // 50% of screen width
              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  child: Icon(
                    Icons.place,
                    color: Colors.white,
                    size: circleRadius * 0.5, // Modify this value to adjust the icon size
                  ),
                ),
              ),
            ),
          ),
          SizedBox(height: circleSpacing), // Adjust this value to change the space between the circles
          Flexible(
            flex: 1,
