...
class _ConnectedDeviceScreenState extends State<ConnectedDeviceScreen> {
  ...
  @override
  Widget build(BuildContext context, {double circleSpacing = 50.0}) {
    final Size size = MediaQuery.of(context).size;
    final double circleRadius = size.width * 0.6; // 50% of screen width
    ...
    return Scaffold(
      ...
      body: Padding(
        padding: EdgeInsets.symmetric(vertical: circleSpacing), // Add padding at the top and bottom
        child: Column(
          children: [
            Flexible(
              flex: 1,
