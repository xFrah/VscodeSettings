...
def convert_to_groundtruth_bbox(json_data, video_width, video_height):
        ...
        for result in annotation['result']:
            ...
            for sequence in result['value']['sequence']:
                if sequence['enabled']:
                    ...
                    # Convert percentages to actual pixel values based on video dimensions, then normalize
                    lt_x = sequence['x'] / video_width
                    lt_y = sequence['y'] / video_height
                    rb_x = (sequence['x'] + sequence['width']) / video_width
                    rb_y = (sequence['y'] + sequence['height']) / video_height
  ...
  "annotations": [
    {
      ...
      "created_ago": "2 hours, 11 minutes",
      "completed_by": {
        "id": 1,
        "first_name": "",
        "last_name": "",
            ...
            "sequence": [
              {
                ...
                "x": 97.11538461538463,
                "y": 96.3980463980464,
                "width": 2.33516483516483,
                "height": 2.6862026862026713,
                "time": 0.04
              }
            ],
            "labels": [
      ...
      "updated_at": "2024-02-22T21:24:32.344509Z",
      "draft_created_at": "2024-02-22T19:12:34.917009Z",
      "lead_time": 209.67800000000003,
      "import_id": null,
      "last_action": null,
      "task": 1,
      "project": 1,
...
lines = convert_to_groundtruth_bbox(json_data, 1920, 1080)
for line in lines:
    print(line)