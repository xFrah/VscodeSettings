        ...
        for result in annotation['result']:
            ...
            for sequence in result['value']['sequence']:
                if sequence['enabled']:
                    ...
                    lt_x = (sequence['x'] / 100) * video_width / video_width
                    lt_y = (sequence['y'] / 100) * video_height / video_height
                    rb_x = ((sequence['x'] + sequence['width']) / 100) * video_width / video_width
                    rb_y = ((sequence['y'] + sequence['height']) / 100) * video_height / video_height
