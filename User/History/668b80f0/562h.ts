...
import { calculateHourlyOvertimePercentage, countOvertimeOccurrences, createAWS_S3_URL, correctHeadAndTail} from "./worker_report.resolver";
...
export async function getCostMarginBudgetDashboardDetails(parent, args, contextValue) {
    ...
    try {
        ...
        data["cost"] = data["totalCostOfExpences"] + data["totalValueOfReceipt"] + data["totalCostOfWorker"];
