...
class ForexEnv:
    def __init__(self, data):
        # Store the data
        self.data = data
        # data is a day of data, each element is a candle that represents 1 minute, each element is a dictionary of 6 elements:
        # 0: datetime
        # 1: open price
        # 2: high price
        # 3: low price
    ...
    def step(self, action):
        ...
        current_price = self.data[self.current_step]["close"]  # close price
