...
def create_image_with_label(label_text):
    # get unknown.png
    unknown_image = cv2.imread("unknown.png", cv2.IMREAD_UNCHANGED)
    ...
    label_y = int(0.3 * height)  # 0.7 of the image height
...
if __name__ == "__main__":
    ...
    cv2.imshow("image", create_image_with_label("Hello World"))
    cv2.waitKey(0)
