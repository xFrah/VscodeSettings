...
class Console:
    ...
    def __init__(self, window_size, portion=1 / 3):
        ...
        self.drawable = console_rect = pygame.Rect(console_pos, console_size)
...
def pygame_loop():
    ...
    console_pos = (0, int(height * (2 / 3)))
    console_size = (width, int(height * (1 / 3)))

    #. create rectangle for console area to blit it later
    console_rect = pygame.Rect(console_pos, console_size)

    screen = pygame.display.set_mode((width, height), pygame.RESIZABLE)

    # create a font
    font = pygame.freetype.SysFont("Cascadia Mono", 25)

    # create a text surface
    text = font.render("Hello World!", (255, 255, 255))
    ...
    while True:
        ...
        if width != pygame.display.get_surface().get_width() or height != pygame.display.get_surface().get_height():
            ...
            console_pos = (0, int(height * (4 / 6)))
            console_size = (width, int(height * (2 / 6)))
            console_rect = pygame.Rect(console_pos, console_size)
        ...
        pygame.draw.rect(screen, (30, 30, 30), console_rect)
