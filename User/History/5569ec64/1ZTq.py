...
distance = 500  # distance to the next car (m)
actual_speed = 80  # current speed of the car (m/s)
...
# create opencv window with name 'plot' and add slider with callback to change the distance
cv2.namedWindow("plot")
cv2.createTrackbar("distance", "plot", 500, 1000, callback)
