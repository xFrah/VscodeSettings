...
class _ItemRegistrationViewState extends State<ItemRegistrationView> {
  ...
  final List<Map<String, dynamic>> _items = [
    ...
    {'icon': Icons.masks, 'text': 'Masks'},
    {'icon': Icons.vaccines, 'text': 'Injection'},
    {'icon': Icons.sanitizer, 'text': 'Sanitizer'},
    {'icon': Icons.medication_liquid, 'text': 'Liquid'},
    {'icon': Icons.bedroom_baby, 'text': 'Horse'},
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: GridView.count(
        padding: EdgeInsets.all(5), // Add padding at the top
