...
class _ReadyViewState extends State<ReadyView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color(0xffab6e3c), // Background color
      body: _ready
          ...
          : Center(
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: Color(0xffedc29f), // Circle color
                ),
                child: Center(
                  child: Column(
                    ...
                    children: <Widget>[
                      Icon(
                        ...
                        size: 100.0,
                        color: Color(0xffab6e3c), // Icon color
                      ),
                      Padding(
                        padding:
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                              fontSize: 24,
                              color: Color(0xffab6e3c)), // Text color
                        ),
                      ),
                    ],
                  ),
