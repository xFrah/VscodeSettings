    ...
    while True:
        ...
        while True:
            ...
            if start_idx == -1:
                ...
                print("Invalid header. Discarding data.")
                break

            buffer = buffer[start_idx:]
            # or
            # buffer = buffer[buffer.find(b'PART'):]
            # or
            del buffer[:buffer.find(b'PART')]
            ...
            if len(buffer) < packet_end:
                print("Incomplete packet. Waiting for more data.", len(buffer))
                break  # Wait for more data
