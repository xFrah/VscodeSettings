...
time_after_last_feature: int = 10
working: bool = True
...
if __name__ == "__main__":
    ...
    change_detector = change_detection.onnx_load_model("models/cd_332.onnx")
        ...
        if success:
            ...
            if boxes is not None:
                for box, score, cl in zip(boxes, scores, classes):
                    ...
                    cv2.putText(img, "{0} {1:.2f}".format(CLASSES[cl], score), (top, left - 6), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 0, 255), 2)
