...
while True:
    ...
    y = y / np.sum(y)
    # now we generate random samples from the probability distribution and we should get a normal distribution with mean 0.25 and std = sqrt((mean * (1 - mean)) / n) without knowing y
