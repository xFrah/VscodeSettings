...
class PN532:
    ...
    def init_as_target(self):
        ...
        command = [
            ...
            # // MIFARE PARAMS
            0x04,
            0x00,  # SENS_RES (seeeds studio set it to 0x04, nxp to 0x08)
            0x00,
            0x00,
            ...
            # // FELICA PARAMS
            0x01,
            0xFE,  # NFCID2t (8 bytes) https://github.com/adafruit/Adafruit-PN532/blob/master/Adafruit_PN532.cpp FeliCa NEEDS TO BEGIN WITH 0x01 0xFE!
            0x05,
            0x01,
            0x86,
            0x04,
            ...
            0x00,
            0xFF,
            0xFF,  # System code (2 bytes)
            0x01,
            0x01,
            0x66,  # NFCID3t (10 bytes)
            0x6D,
            0x01,
            0x01,
            0x10,
        ...
        self.call_function(_COMMAND_TGINITASTARGET, params=command)

    def set_data(self, data):
        """Set data for a target to send"""
        # data is str, convert to bytes
