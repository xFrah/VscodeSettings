...
audio_outputs = ["Speaker (Realtek(R) Audio)", "Audio Output 2"]

# Call the function to play audio tracks on different outputs
play_audio_tracks(video_path, audio_outputs)
