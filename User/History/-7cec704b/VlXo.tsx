...
function AnalysisCharts({ ProjectData }) {
  ...
  const data2 = [
    ["Total Budget", "Fee", "Fixed Cost", "Cost", "Not Used Budget", "Over Budget"],
    [
      `${ProjectData?.getCostMarginBudgetDashboardDetails?.name}`,
      fee,
      fixedCost,
      isOverBudget ? totalBudget : totalCost, // If over budget, show budget as the cost
      notUsedBudget,
      overBudgetCost
    ],
  ];
          ...
          <View className="flex flex-row w-2/3">
            <Chart
              ...
              options={{
                ...
                colors: isOverBudget ? ["#009997", "#e8e0a7", "#ff0000", "#d56100", "#808080"] : ["#009997", "#e8e0a7", "#d56100", "#808080"],
