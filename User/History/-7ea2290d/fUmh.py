...
print("1 " + str(micropython.mem_info()))
...
print("12 " + str(micropython.mem_info()))
...
print("123 " + str(micropython.mem_info()))

from microdot import Microdot as BaseMicrodot
print("1234 " + str(micropython.mem_info()))
from microdot import mro
print("12345 " + str(micropython.mem_info()))
from microdot import NoCaseDict
print("123456 " + str(micropython.mem_info()))
from microdot import Request as BaseRequest
print("1234567 " + str(micropython.mem_info()))
from microdot import Response as BaseResponse
print("12345678 " + str(micropython.mem_info()))
from microdot import print_exception
print("123456789 " + str(micropython.mem_info()))
from microdot import HTTPException
print("1234567899 " + str(micropython.mem_info()))
from microdot import MUTED_SOCKET_ERRORS
print("12345678999 " + str(micropython.mem_info()))
...
class Request(BaseRequest):
    ...
    async def create(app, client_reader, client_writer, client_addr):
        ...
        return Request(app, client_addr, method, url, http_version, headers, body=body, stream=stream, sock=(client_reader, client_writer))
        ...
        if req:
            if req.content_length > req.max_content_length:
                ...
                try:
                    ...
                    if exc_class:
                        try:
                            res = await self._invoke_handler(self.error_handlers[exc_class], req, exc)
