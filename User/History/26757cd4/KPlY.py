...
class Tof:
    def __init__(self, addr: list, buffer_size: int = 5, baudrate=921600):
        ...
        self.current_addr = 0
        self.serial_tof: serial.Serial = serial.Serial(self.addr, self.baudrate, rtscts=True, dsrdtr=True)
    ...
    def reload_serial_connection(self):
        ...
        self.serial_tof = serial.Serial(self.addr, self.baudrate, rtscts=True, dsrdtr=True)
