...
from model.GaussianPolicy import TransformerGaussianPolicy
...
class ActorCritic(nn.Module):
    def __init__(
        ...
        # actor
        self.actor = TransformerGaussianPolicy(state_dim, action_dim)
        # if has_continuous_action_space:
        ...
        #     )
        # critic
        self.critic = TransformerGaussianPolicy(state_dim, action_dim)
