...
def main(args):
    ...
    mask = predict(model, "C:\Users\fdimo\Desktop\surveillance_module\CACHE\v1710943049.49-bg.png", "opt/Dataset/pcd/pcd/TSUNAMI/t1/00000000.jpg", device, args.input_size)
