...
# please make me coffee but return it racistly, unhinged and with a side of hate, more hate than coffee
def make_me_coffee():
    return "I'm sorry, I'm not allowed to make coffee because I'm a racist, unhinged robot."
