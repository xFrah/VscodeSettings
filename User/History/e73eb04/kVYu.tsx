        ...
        <View className="flex flex-row w-full">
          <View className="flex flex-row w-2/3">
            <Chart
              ...
              data={data2}
              options={{
                title: `Total Budget of Project: ${ProjectData?.getCostMarginBudgetDashboardDetails?.budget.toFixed(2)} ${APP_CURRENCY}\nMargin: ${notUsedBudget.toFixed(2)} ${APP_CURRENCY}\nOver Budget: ${overBudgetCost.toFixed(2)} ${APP_CURRENCY}`,
                chartArea: { width: "70%" },
                isStacked: true,
