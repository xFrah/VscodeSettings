...
if __name__ == "__main__":
    ...
    text_lines[6]["params"][0] = receipt["Receipt rows"]
    text_lines[11]["params"][0] = str(padded_cents_to_euros(receipt["Approved or Authorized Amount"]))
    text_lines[15]["params"][0] = receipt["CVMR"]
    text_lines[19]["params"][0] = receipt["IAD"]
    text_lines[23]["params"][0] = receipt["AC"]
    text_lines[27]["params"][0] = receipt["TVR"]
    text_lines[31]["params"][0] = receipt["UN"]
    text_lines[35]["params"][0] = receipt["TrCC"]
    text_lines[39]["params"][0] = receipt["TT"]
    text_lines[43]["params"][0] = receipt["TCC"]
    text_lines[47]["params"][0] = receipt["ATC"]
    text_lines[51]["params"][0] = receipt["APPL_LABEL"]
    text_lines[55]["params"][0] = receipt["AID"]
    text_lines[63]["params"][0] = receipt["PAN"]
    # Authorization Response Code
    text_lines[67]["params"][0] = receipt["Authorization Response Code"]
    text_lines[75]["params"][0] = receipt["ARC"]
    text_lines[79]["params"][0] = "ICC"
    text_lines[83]["params"][0] = receipt["OPS"]
    text_lines[87]["params"][0] = receipt["STAN"]
