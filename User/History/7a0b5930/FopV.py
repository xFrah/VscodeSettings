...
if __name__ == "__main__":
    ...
    text_lines[97]["params"][0] = receipt["STAN"]
    text_lines[91]["params"][0] = receipt["Terminal Identifier"]
    parsed_datetime = datetime.strptime(
        receipt["Transaction Date and Time"], "%d%m%y%H%M%S"
    )
    text_lines[95]["params"][0] = parsed_datetime.strftime("%Y-%m-%d %H:%M:%S")
    text_lines[99]["params"][0] = receipt["Acquirer ID"]
    text_lines[103]["params"][0] = receipt["Merchant Identifier"]
    text_lines[107]["params"][0] = "ARRIVEDERCI E GRAZIE"
