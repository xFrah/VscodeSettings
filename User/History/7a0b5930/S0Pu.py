...
if __name__ == "__main__":
    ...
    text_lines[49]["params"][0] = receipt["TCC"]
    text_lines[53]["params"][0] = receipt["ATC"]
    text_lines[57]["params"][0] = receipt["APPL_LABEL"]
    text_lines[61]["params"][0] = receipt["AID"]
    text_lines[69]["params"][0] = receipt["PAN"]
    # Authorization Response Code
    text_lines[73]["params"][0] = receipt["Authorization Response Code"]
    text_lines[81]["params"][0] = receipt["ARC"]
    text_lines[85]["params"][0] = "ICC"
    text_lines[89]["params"][0] = receipt["OPS"]
    text_lines[93]["params"][0] = receipt["STAN"]
    text_lines[97]["params"][0] = receipt["Terminal Identifier"]
    parsed_datetime = datetime.strptime(
        receipt["Transaction Date and Time"], "%d%m%y%H%M%S"
    )
    text_lines[101]["params"][0] = parsed_datetime.strftime("%Y-%m-%d %H:%M:%S")
    text_lines[105]["params"][0] = receipt["Acquirer ID"]
    text_lines[109]["params"][0] = receipt["Merchant Identifier"]
