...
if __name__ == "__main__":
    ...
    text_lines[44]["params"][0] = receipt["TCC"]
    text_lines[48]["params"][0] = receipt["ATC"]
    text_lines[52]["params"][0] = receipt["APPL_LABEL"]
    text_lines[56]["params"][0] = receipt["AID"]
    text_lines[64]["params"][0] = receipt["PAN"]
    # Authorization Response Code
    text_lines[68]["params"][0] = receipt["Authorization Response Code"]
    text_lines[76]["params"][0] = receipt["ARC"]
    text_lines[80]["params"][0] = "ICC"
    text_lines[84]["params"][0] = receipt["OPS"]
    text_lines[88]["params"][0] = receipt["STAN"]
    text_lines[92]["params"][0] = receipt["Terminal Identifier"]
    parsed_datetime = datetime.strptime(
        receipt["Transaction Date and Time"], "%d%m%y%H%M%S"
    )
    text_lines[96]["params"][0] = parsed_datetime.strftime("%Y-%m-%d %H:%M:%S")
    text_lines[100]["params"][0] = receipt["Acquirer ID"]
    text_lines[104]["params"][0] = receipt["Merchant Identifier"]
