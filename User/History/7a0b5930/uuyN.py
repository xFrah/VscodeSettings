...
if __name__ == "__main__":
    ...
    text_lines[18]["params"][0] = str(padded_cents_to_euros(receipt["Approved or Authorized Amount"]))
    text_lines[22]["params"][0] = receipt["CVMR"]
    text_lines[26]["params"][0] = receipt["IAD"]
    text_lines[30]["params"][0] = receipt["AC"]
    text_lines[34]["params"][0] = receipt["TVR"]
    text_lines[38]["params"][0] = receipt["UN"]
    text_lines[42]["params"][0] = receipt["TrCC"]
    text_lines[46]["params"][0] = receipt["TT"]
    text_lines[51]["params"][0] = receipt["TCC"]
    text_lines[55]["params"][0] = receipt["ATC"]
    text_lines[59]["params"][0] = receipt["APPL_LABEL"]
    text_lines[63]["params"][0] = receipt["AID"]
    text_lines[71]["params"][0] = receipt["PAN"]
    # Authorization Response Code
    text_lines[75]["params"][0] = receipt["Authorization Response Code"]
    text_lines[83]["params"][0] = receipt["ARC"]
    text_lines[87]["params"][0] = "ICC"
    text_lines[91]["params"][0] = receipt["OPS"]
    text_lines[95]["params"][0] = receipt["STAN"]
    text_lines[99]["params"][0] = receipt["Terminal Identifier"]
    parsed_datetime = datetime.strptime(
        receipt["Transaction Date and Time"], "%d%m%y%H%M%S"
    )
    text_lines[103]["params"][0] = parsed_datetime.strftime("%Y-%m-%d %H:%M:%S")
    text_lines[107]["params"][0] = receipt["Acquirer ID"]
    text_lines[111]["params"][0] = receipt["Merchant Identifier"]
    text_lines[11]["params"][0] = receipt["Receipt rows"]
    text_lines[114]["params"][0] = receipt["ARRIVEDERCI E GRAZIE"]
    text_lines[116]["params"][0] = receipt["Transazione autorizzata"]
