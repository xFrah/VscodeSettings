...
from change_detector_model.Backbone import backbone_mtf_msf, unibackbone_fpn, mtf_backbone_msf, backbone_msf_mtf, backbone_msf
from change_detector_model.Backbone import MTF
...
def vgg16bn_mtf_msf_deeplabv3(msf, mtf, num_classes):
    backbone = backbone_mtf_msf('vgg16_bn', fpn_num=msf, mode=mtf)
    aux_classifier = None
