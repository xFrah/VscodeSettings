...
class MOG:
    ...
    def forward(self, distances_mm, display=None):
        ...
        if not np.all(mask == 0):
            ...
            print(f"[INFO] MOG 5 took {(time.time() - start) * 1000} ms")
            print(f"[INFO] MOG 6 took {(time.time() - start2) * 1000} ms")
