...
def parse_E(packet_bytes):
    ...
    packet_structure = [
        ...
        ("TVR", 10),  # Terminal Verification Results
        ("AC", 16),  # Application Cryptogram
        ("IAD", 64),  # Issuer Application Data
        ("ARC", 2),  # Authorisation Response Code
        ("APPL_LABEL", 16),  # Application Label
        ("ATC", 4),  # Application Transaction Counter
        ("TCC", 3),  # Terminal Country Code
        ("TT", 2),  # Transaction Type
        ("TrCC", 3),  # Transaction Currency Code
        ("UN", 8),  # Unpredictable Number
        ("TSI", 4),  # Transaction Status Information
        ("TAC", 30),  # Terminal Action Codes
        ("CVMR", 6),  # Cardholder Verification Method Results
        ("AUC", 4),  # Application Usage Control
        ("AIP", 4),  # Application Interchange Profile
        ("IAC", 30),  # Issuer Action Codes
        ("CID", 2),  # Cryptogram Information Data
        ("OPS", 1),  # Online Processing Status
        ("ApplPN", 16),  # Application Preferred Name
        ("CTQ", 4),  # PayWave Card Transaction Qualifiers
        ("AID", 32),  # Application Identifier
        ("RFU", 64),  # Reserved for Future Use (repeat RFU for simplicity)
        ("ETX", 1),
        ("LRC", 1),
    ]
...
if __name__ == "__main__":
    example_packet = br'\x02925411880E0000000000040CLI0000001000002000000101212231036131Mastercard      ************0381   00003000000000000*                        ANTIQUARIUM CANNE BATTAGSP 142 CANNE DELLA BATTAARRIVEDERCI E GRAZIE    Cod. Commerc: 22537427               \n       841359493461400040002     00000000              0000008001C430CFE19AFE69470114A14003020000000400000000000000FF                                00MASTERCARD      000938000978ED693EE0                                  3F0002FFC01B80                           
       801                    A0000000041010                                                                                  \x03+'
