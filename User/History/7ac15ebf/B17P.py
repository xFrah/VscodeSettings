...
def parse_E(packet_bytes):
    ...
    for field_name, field_length in packet_structure:
        ...
        if field_name == 'Transaction Result':
            result[field_name] = transaction_result_interpretation.get(result[field_name], 'Unknown')
        elif field_name == 'Card Type':
            result[field_name] = card_type_interpretation.get(result[field_name], 'Unknown')
        elif field_name == 'Approval Type':
            result[field_name] = approval_type_interpretation.get(result[field_name], 'Unknown')
