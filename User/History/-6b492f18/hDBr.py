...
class ActorCritic(nn.Module):
    def __init__(
        ...
        # actor
        self.actor = TransformerPolicy(state_dim, action_dim, n_transformer_layers=3, d_ff_inner=160)
        # if has_continuous_action_space:
        ...
        #     )
        # critic
        self.critic = TransformerPolicy(state_dim, 1, n_transformer_layers=3, d_ff_inner=160)
