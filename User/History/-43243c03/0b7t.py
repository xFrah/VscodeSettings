...
class Tof:
    def __init__(self, addr: list, buffer_size: int = 5, baudrate=115200):
        self.addr = addr
        self.baudrate = baudrate
        # print("Tof >> Opening serial port: ", self.com)
        self.current_addr = 0
        self.serial_tof: serial.Serial = serial.Serial(self.addr[self.current_addr], self.baudrate)
    ...
    def reload_serial_connection(self):
        ...
        self.serial_tof = serial.Serial(self.get_next_addr(), self.baudrate)
