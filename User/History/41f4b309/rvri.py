# import subprocess
from drone_helpers import Drone
...
for waypoint in waypoints_list:
    ...
    res = waypoint.wait()  # wait for waypoint to finish
    if not res:  # if waypoint failed
        print(f"{waypoint} failed")
        break
    print(f"{waypoint} succeeded")
