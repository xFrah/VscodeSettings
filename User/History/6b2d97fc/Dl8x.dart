...
bool wifi_setup(String deviceId, String new_ssid, String new_pass,
    {int timeout = 5000}) {
      ...
      body: Column(
        children: [
          ...
          ElevatedButton(
            child: Text('send'),
            onPressed: () async {
              wifi_setup(widget.deviceId, "new_ssid", "new_pass");
              // call the function above but with compute to run it in a separate isolate
              var result = await compute(wifi_setup, widget.deviceId, "new_ssid", "new_pass");
            },
          ),
        ],
      ),
