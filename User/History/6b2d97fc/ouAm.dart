...
Future<bool> wifi_setup(String deviceId, String new_ssid, String new_pass,
  ...
  await ensure_connection(deviceId);
  ...
  try {
    await QuickBlue.writeValue(deviceId, CMD_SERVICE_UUID, CMD_RX_CHAR_UUID,
        wifi_setup_cmd, BleOutputProperty.withResponse).timeout(Duration(milliseconds: 2000));
  } catch (e) {
    ...
    for (var characteristicId in characteristicIds) {
      ...
      try {
        if (characteristicId ==
          ...
          await QuickBlue.setNotifiable(deviceId, serviceId, characteristicId,
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              try {
                ...
                print('wifi_setup timed out after 5 seconds, exception: $e');
              } catch (e) {
