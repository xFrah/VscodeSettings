...
def train():
    ...
    dataset = np.load("dataset/EURUSD_M1.npy")
    # load
    env_df = pd.read_csv("dataset/EURUSD_M1_env.csv", parse_dates=True)
    ################################

    ####### initialize environment hyperparameters ######
    env_name = "training-v1"

    has_continuous_action_space = True  # continuous action space; else discrete

    max_ep_len = 1440  # max timesteps in one episode
    ...
    env = gym.make(env_name, df=env_df, positions=[-1, 0, 1], initial_position=1)
