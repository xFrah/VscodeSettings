...
class _ImageDisplayPageState extends State<ImageDisplayPage> {
  ...
  Widget build(BuildContext context) {
    ...
    // Calculate total vertical margin space
    double totalVerticalMarginSpace = (3 - 1) * verticalMargin;

    // Available height for each button after accounting for margins
    double buttonHeight =
        (MediaQuery.of(context).size.height / 3 - totalVerticalMarginSpace) / 3;
