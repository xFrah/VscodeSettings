...
if __name__ == "__main__":
    ...
    mapL1, mapL2 = cv.initUndistortRectifyMap(cmtx0, dist0, R1, P1, (640, 480), cv.CV_16SC2)
    mapR1, mapR2 = cv.initUndistortRectifyMap(cmtx1, dist1, R2, P2, (640, 480), cv.CV_16SC2)
    ...
    while True:
        ...
        disparity = stereo.compute(imgR_u, imgL_u)
