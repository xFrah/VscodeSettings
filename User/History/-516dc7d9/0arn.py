...
if __name__ == "__main__":
    ...
    cv.createTrackbar("numDisparities", "disparity", 16, 64, numDisparities_callback)
    cv.createTrackbar("blockSize", "disparity", 15, 21, blockSize_callback)

    nd = 16
    bs = 15

    # set callbacks
    cv.setTrackbarPos("numDisparities", "disparity", nd)
    cv.setTrackbarPos("blockSize", "disparity", bs)
