...
# given the list of mean vectors, the test image and the number of nearest neighbors, returns the predicted label
def knn(mean_vectors, test_image, k):
    distances = [np.linalg.norm(test_image - mean_vector) for mean_vector in mean_vectors]
