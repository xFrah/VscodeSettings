...
class Interfaces:
    def __init__(self) -> None:
        ...
        self.load_interface_names()
        self.save_interface_names()
    ...
    def save_interface_names(self):
        """
        Save the translation between the interface name and the interface guid.
        """
        with open("interface_names.json", "w") as f:
            json.dump(self.interface_names, f)

    def update_interface_names(self, update_dict: dict[str, str]):
        """
        ...
        self.interface_names = prev_interface_names
