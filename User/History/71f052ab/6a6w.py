...
class Tracks:
    ...
    def get_track(self, index: int) -> str:
        return self.tracks[index]

    def get_track_index(self, track: str) -> int:
...
class Interfaces:
    def __init__(self) -> None:
        ...
        self.interfaces: list[Interface] = [Interface(t_int[guid], guid) for guid in self.guids]
    ...
    def reload_interfaces(self):
        ...
        self.update_interface_names(t_int, include_new_interfaces=False)
