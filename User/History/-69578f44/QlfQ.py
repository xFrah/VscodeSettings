...
def draw(distances, frame=None):
    ...
    distances = sorted(
        [
            ...
            if 30 < y < 60000 and (angle_lower_limit_1 <= x <= angle_upper_limit_1 or angle_lower_limit_2 <= x <= angle_upper_limit_2)
        ],
        key=lambda x: x[0],
    )
    x, y = zip(*distances)
    ...
    cv2.line(
        ...
        (500, 500),
        (
            int(500 + 3000 * scale * math.cos(math.radians(angle_lower_limit_1))),
            int(500 + 3000 * scale * math.sin(math.radians(angle_lower_limit_1))),
        ),
        (255, 255, 255),
        1,
    )
    cv2.line(
        ...
        (500, 500),
        (
            int(500 + 3000 * scale * math.cos(math.radians(angle_upper_limit_2))),
            int(500 + 3000 * scale * math.sin(math.radians(angle_upper_limit_2))),
        ),
        (255, 255, 255),
        1,
    )
...
if __name__ == "__main__":
    lidar = Lidar(port="COM3", slices=True, buffer_size=1)
