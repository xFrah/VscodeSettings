    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          With this, when you swipe down from the top of the ListView, it'll trigger the _refreshList function which will make an HTTP GET request and then update the list.
