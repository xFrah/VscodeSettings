...
class _DeviceListScreenState extends State<DeviceListScreen> {
  ...
  Future<Map<String, dynamic>?> _fetchDeviceDetail(String macAddress) async {
    String? token = await storage.read(key: 'jwt');
    final response = await http.get(
      Uri.parse('http://5.196.23.212:8080/get_device_detail?mac=$macAddress'),
      headers: {
                  ...
                  return Padding(
                    ...
                    child: Card(
                      ...
                      child: ListTile(
                        ...
                        onTap: () async {
                          final deviceDetail =
                              await _fetchDeviceDetail(macAddress);
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => ImageDisplayPage(
                                  companyName:
                                      "asd", // You can replace these values
                                  username:
                                      "asd", // with data from `deviceDetail` if needed.
                                  deviceData:
                                      deviceDetail, // Passing the data to the next page.
                                ),
                              ),
                            );
                          } else {
                            // Optionally, show a toast or an error message indicating there was a problem.
                          }
                        },
