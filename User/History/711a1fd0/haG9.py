...
class ROI:
    ...
    def get_cropped_and_translated_image3(self, image):
        ...
        M = cv2.getPerspectiveTransform(roi_polygon_adjusted, np.array([[0, 0], [860, 0], [860, 256], [0, 256]], np.float32))
        warped_image = cv2.warpPerspective(image, M, (860, 256))

        # get the cropped image
        cropped_image = warped_image[0:256, 0:860]
