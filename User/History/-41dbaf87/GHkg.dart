...
import './ConfermaPrelievo.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Preleva extends StatelessWidget {
  Preleva({
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            alignment: Alignment(-0.391, -0.196),
            child: SizedBox(
              width: 69.0,
              height: 19.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.289, -0.143),
            child: SizedBox(
              width: 118.0,
              height: 15.0,
              child: Text(
          ...
          Pinned.fromPins(
            ...
            Pin(size: 23.3, middle: 0.4125),
            child: PageLink(
              links: [
                PageLinkInfo(
                  pageBuilder: () => ConfermaPrelievo(),
                ),
              ],
              child: Stack(
                children: <Widget>[
          ...
          Align(
            alignment: Alignment(-0.371, -0.063),
            child: SizedBox(
              width: 80.0,
              height: 19.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.289, -0.01),
            child: SizedBox(
              width: 118.0,
              height: 15.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.405, 0.07),
            child: SizedBox(
              width: 61.0,
              height: 19.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.289, 0.122),
            child: SizedBox(
              width: 118.0,
              height: 15.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.41, 0.203),
            child: SizedBox(
              width: 58.0,
              height: 19.0,
              child: Text(
          ...
          Align(
            alignment: Alignment(-0.289, 0.254),
            child: SizedBox(
              width: 118.0,
              height: 15.0,
              child: Text(
