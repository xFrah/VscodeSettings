          ...
          for (var service in services) {
            for (var characteristic in service.characteristics) {
              if (characteristic.uuid.toString() == CMD_RX_CHAR_UUID) {
                ...
                streamsub2 = characteristic.onValueReceived.listen((value) {
                ...
                scanSubscription
                    ?.cancel(); // Stop scanning once we found our device
                streamsub2.cancel(); // Stop listening once we found our device
                return;
              } else {
                print("[BLE] Found characteristic: ${characteristic.uuid}...");
              }
