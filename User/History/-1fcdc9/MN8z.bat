...
start cmd.exe /k "VLC --http-port 8091 --audio-track=0  --fullscreen --directx-audio-device={E0B0541A-E424-4F0F-A01B-210009BC4862} "C:\Users\DadoR\Videos\The.Italian.Job.2003.BDRip.720p.x264.AC3.ITA-ENG.mkv" ì