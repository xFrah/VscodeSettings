...
def killswitch():
    """This route is used to kill the clients if needed."""
    # get terminal_id parameter from url
    [terminal_id] = requires_arguments("terminal_id")
    print(f"Terminal {terminal_id} will live another day.")
    return "OK"
