...
def lidar_draw(packet, scaling_factor, closest_person, closest_object, lidar_threshold, object_threshold) -> np.ndarray:
    ...
    for angle, distance in packet["points"]:
        ...
        x = 500 + (distance * scale) * math.cos(math.radians(angle - 90))
        y = 500 + (distance * scale) * math.sin(math.radians(angle - 90))
    ...
    for person_angle, distance in packet["people"]:
        x = 500 + (distance * scale) * math.cos(math.radians(person_angle - 90))
        y = 500 + (distance * scale) * math.sin(math.radians(person_angle - 90))
    ...
    cv2.line(
        ...
        (500, 500),
        (
            int(500 + (50000 * scale) * math.cos(math.radians(angle_lower_limit_1 - 90))),
            int(500 + (50000 * scale) * math.sin(math.radians(angle_lower_limit_1 - 90))),
        ),
        (0, 255, 0),
        1,
    )
    ...
    cv2.line(
        ...
        (500, 500),
        (
            int(500 + (50000 * scale) * math.cos(math.radians(angle_upper_limit_2 - 90))),
            int(500 + (50000 * scale) * math.sin(math.radians(angle_upper_limit_2 - 90))),
        ),
        (0, 255, 0),
        1,
    )
    ...
    cv2.ellipse(
        ...
        0,
        angle_lower_limit_1 - 90,
        angle_upper_limit_1 - 90,
        (0, 255, 0),
        1,
    )
    ...
    cv2.ellipse(
        ...
        (int(lidar_threshold * scale), int(lidar_threshold * scale)),
        0,
        angle_lower_limit_2 - 90,
        angle_upper_limit_2 - 90,
        (0, 255, 0),
        1,
    )
    ...
    if closest_person is not None:
        x = 500 + (closest_person[1] * scale) * math.cos(math.radians(closest_person[0] - 90))
        y = 500 + (closest_person[1] * scale) * math.sin(math.radians(closest_person[0] - 90))
    ...
    if closest_object is not None:
        x = 500 + (closest_object[1] * scale) * math.cos(math.radians(closest_object[0] - 90))
        y = 500 + (closest_object[1] * scale) * math.sin(math.radians(closest_object[0] - 90))
