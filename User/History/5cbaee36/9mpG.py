...
class SendingAmount:
     ...
     * Amount Value
     * 
     * The amount is coded in hundredth of euros, filled with "0" (30 hex) 
     * characters on the left
     * E.g.: "00004532" for \u20ac 45,32
     */
    protected $amountValue = '00000000';

    /**
     * Ticket Number
     * 
     * Used for additional information provided by the PC
     * for specific applications; if not used, must be filled
     * with "0" characters (30 hex)
     */
    protected $ticketNumber = '000000';

    public function getStringToSend() {
        $this->raw = STX .
