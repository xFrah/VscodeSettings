        ...
        children: [
          ...
          Expanded(
            child: ListView.builder(
              itemCount: widget
                  .jsonData["contents"].entries.length, // <-- Updated this line
              itemBuilder: (context, index) {
                ...
                final MapEntry<String, List<dynamic>> entry = widget
                    .jsonData["contents"].entries
                    .elementAt(index); // <-- Updated this line

                final expiration_date = entry
                    .value[0]; // Assuming the Tuple has at least one element

                final id = entry
                    .key; // Assuming the Tuple has at least two elements

                return _listItem(randomIcon, entry.key, expiration_date, id);
              },
            ),
          )
        ],
