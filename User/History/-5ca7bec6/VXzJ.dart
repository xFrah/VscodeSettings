...
class _GestisciContenutoState extends State<GestisciContenuto> {
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return _listItem(randomIcon, entry.key, widget.jsonData["expirations"][id]);
              },
            ),
          )
        ],
  ...
  Widget _listItem(Icon iconData, String item_type, String id) {
    // check if id is in jsonData["missing"]
    final bool isMissing = widget.jsonData["missing"].contains(id);
