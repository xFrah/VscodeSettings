...
class _GestisciContenutoState extends State<GestisciContenuto> {
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final MapEntry<String, List<dynamic>> entry =
                    widget.jsonData["contents"].entries.elementAt(index);

                final expiration_date = entry.value[0];
                final id = entry.key;
                final bool isMissing = entry.value[1];
  ...
  Widget _listItem(
      Icon iconData, String item_type, String id, String id2, bool isMissing) {
