...
class StableTransformerXL(torch.nn.Module):
    def __init__(
        ...
        self.linear1 = torch.nn.Linear(d_input, d_input)
        self.drop1 = torch.nn.Dropout(dropout)
        self.linear2 = torch.nn.Linear(d_input, action_space)
    ...
    def forward(self, inputs, memory=None):
        ...
        # perform pooling to transform layer_out from [seq_len x batch_size x d_inner] to [batch_size x d_inner]
